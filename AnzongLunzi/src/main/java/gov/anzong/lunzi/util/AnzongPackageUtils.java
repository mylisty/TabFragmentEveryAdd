...
/**
 * Created by Anh Lai on 2016/9/20 0020.
 * //                            _ooOoo_
 * //                           o8888888o
 * //                           88" . "88
 * //                           (| -_- |)
 ...
 * //                  不见满街漂亮妹，哪个归得程序员？
 */
@SuppressWarnings({"WeakerAccess", "unused", "StringBufferReplaceableByString", "JavaDoc"})
public class AnzongPackageUtils {

    public static final String TAG = "PackageUtils";

    private AnzongPackageUtils() {
     ...
     * <li>else see {@link #installNormal(Activity, String)}</li>
     * </ul>
     *
     * @param context
     * @param filePath
    ...
    public static final int install(Activity context, String filePath) {
        if (AnzongPackageUtils.isSystemApplication(context) || AnzongShellUtils.checkRootPermission()) {
    ...
    public static boolean installNormal(Activity context, String filePath) {
     ...
     * @param context
     * @param filePath file path of package
     * @return {@linkAnzongPackageUtils#INSTALL_SUCCEEDED} means install success, other means failed. details see
     *         {@linkAnzongPackageUtils}.INSTALL_FAILED_*. same to {@link PackageManager}.INSTALL_*
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        AnzongShellUtils.CommandResult commandResult = AnzongShellUtils.execCommand(command.toString(), !isSystemApplication(context), true);
    ...
    public static Boolean isTopActivity(Context context, String packageName) {
        if (context == null || AnzongStringUtils.isEmpty(packageName)) {
            return null;
        }

        ActivityManager activityManager = (ActivityManager)context.getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningTaskInfo> tasksInfo = activityManager.getRunningTasks(1);
        if (AnzongListUtils.isEmpty(tasksInfo)) {
            return null;
        }
        try {
    ...
    public static int getInstallLocation() {
        AnzongShellUtils.CommandResult commandResult = AnzongShellUtils.execCommand(
