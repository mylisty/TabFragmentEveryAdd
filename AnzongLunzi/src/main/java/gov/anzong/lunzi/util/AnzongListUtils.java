...
public class AnzongListUtils {
    ...
    public static <V> boolean isEquals(ArrayList<V> actual, ArrayList<V> expected) {
        ...
        for (int i = 0; i < actual.size(); i++) {
            if (!AnzongObjectUtils.isEquals(actual.get(i), expected.get(i))) {
                return false;
            }
        }
        return true;
    ...
    /**
     * @see {@link AnzongArrayUtils#getLast(Object[], Object, Object, boolean)} defaultValue is null, isCircle is true
     */
    @SuppressWarnings("unchecked")
    public static <V> V getLast(List<V> sourceList, V value) {
        return (sourceList == null) ? null : (V) AnzongArrayUtils.getLast(sourceList.toArray(), value, true);
    }

    /**
     * @see {@link AnzongArrayUtils#getNext(Object[], Object, Object, boolean)} defaultValue is null, isCircle is true
     */
    @SuppressWarnings("unchecked")
    public static <V> V getNext(List<V> sourceList, V value) {
        return (sourceList == null) ? null : (V) AnzongArrayUtils.getNext(sourceList.toArray(), value, true);
    }
