...
/**
 * Created by Anh Lai on 2016/3/23 0023.
 * //                            _ooOoo_
 * //                           o8888888o
 * //                           88" . "88
 * //                           (| -_- |)
 ...
 * //                  不见满街漂亮妹，哪个归得程序员？
 */
public class AnzongArrayUtils {

    private AnzongArrayUtils() {
    ...
    public static <V> V getLast(V[] sourceArray, V value, V defaultValue, boolean isCircle) {
        ...
        for (int i = 0; i < sourceArray.length; i++) {
            if (AnzongObjectUtils.isEquals(value, sourceArray[i])) {
                currentPosition = i;
                break;
            }
        }
    ...
    /**
     * @see {@link AnzongObjectUtils#getLast(Object[], Object, Object, boolean)} defaultValue is null
     */
    ...
    /**
     * @see {@link AnzongObjectUtils#getNext(Object[], Object, Object, boolean)} defaultValue is null
     */
    ...
    /**
     * @see {@link AnzongObjectUtils#getLast(Object[], Object, Object, boolean)} Object is Long
     */
    public static long getLast(long[] sourceArray, long value, long defaultValue, boolean isCircle) {
        ...
        Long[] array = AnzongObjectUtils.transformLongArray(sourceArray);
        return getLast(array, value, defaultValue, isCircle);

    }

    /**
     * @see {@link AnzongObjectUtils#getNext(Object[], Object, Object, boolean)} Object is Long
     */
    ...
    /**
     * @see {@link AnzongObjectUtils#getLast(Object[], Object, Object, boolean)} Object is Integer
     */
    public static int getLast(int[] sourceArray, int value, int defaultValue, boolean isCircle) {
        ...
        Integer[] array = AnzongObjectUtils.transformIntArray(sourceArray);
        return getLast(array, value, defaultValue, isCircle);

    }

    /**
     * @see {@link AnzongObjectUtils#getNext(Object[], Object, Object, boolean)} Object is Integer
     */
    ...
    public static boolean containArray(Integer[] a, Integer[] b) {
        boolean flag = false;
        int k = 0;
