package com.liandongfenqi.tongniu.tabfragmenteveryadd.view;
...
/**
 * Created by tongniu on 2017/8/21.
 */
        ...
        if (child instanceof RadioButton) {
            ...
            ((RadioButton) child).setOnTouchListener(new OnTouchListener() {
              ...
              /*          mCheckedId = child.getId();
                  Log.i("aaaaaaaaaaaa","b"+b);
                        check(child.getId());*/
                        Log.i("aaaaaaaaaaaa","ba"+child.getId());
                        ...
                        public boolean onTouch(View v, MotionEvent event) {
                            ...
                            if(mOnCheckedChangeListener != null){
                             /*   check(button.getId());
                                ...
                                Log.i("aaaaaaaaaaaa","b"+b);
                                mOnCheckedChangeListener.onCheckedChanged(RadioGroup.this, b);
